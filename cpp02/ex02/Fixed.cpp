...
/*   Updated: 2025/03/28 19:03:48 by rhanitra         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool Fixed::operator>(const Fixed& asign) const {
    return this->_fixePointNumberValue > asign._fixePointNumberValue;
}
...
Fixed Fixed::operator+(const Fixed& asign) const {
    return Fixed(this->toFloat() + asign.toFloat());
}
...
Fixed Fixed::operator/(const Fixed& asign) const {
    if (asign._fixePointNumberValue == 0) {
